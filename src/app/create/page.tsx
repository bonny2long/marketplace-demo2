...
import { UploadCloud, Loader2 } from 'lucide-react'; // Import UploadCloud and Loader2 for loading spinner
...
const CreateItemPage = () => {
  ...
  const validateForm = () => {
    ...
    // Condition is not in DB, so making it optional for validation
    ...
    try {
      ...
      if (formData.images.length > 0) {
        ...
        formData.images.forEach((file) => {
          imageFormData.append('file', file); // Append each file with a generic name 'file'
        });
        ...
        // Assuming the first uploaded image URL is the primary one for the listing
      ...
      const listingData = {
        ...
        seller_email: formData.contactEmail, // Using contactEmail as seller_email
        image_url: imageUrl, // Use the uploaded image URL
        location: formData.location,
        // 'condition' is not in your DB schema, so it's omitted here
      };
  ...
  return (
    // Main container for the form, with responsive padding and centering
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <Select onValueChange={(value) => handleSelectChange('category', value)} value={formData.category}>
                  ...
                  <SelectContent>
                    {/* Synchronized category values with sidebar */}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={handleChange}
                  className={`w-full rounded-md border px-3 py-2 ${errors.contactEmail ? 'border-red-500' : 'border-gray-300'} focus:ring-blue-500 focus:border-blue-500`}
                />
          ...
          <CardContent className="p-0 space-y-4">
            ...
            <div className="relative w-full h-64 bg-gray-200 rounded-lg overflow-hidden shadow-md">
              {formData.images.length > 0 ? (
                <Image
                  src={URL.createObjectURL(formData.images[0])} // Show first image as preview
                  alt="Listing Preview"
                  fill
            ...
            <div className="space-y-2 text-gray-700">
              ...
              <p><strong>Contact:</strong> {formData.contactEmail || 'N/A'}</p>
            </div>
